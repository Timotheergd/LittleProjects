...
class MainMenu(Menu):
    ...
    def display_menu(self):
        ...
        while self.run_display:
            ...
            self.game.draw_text("Main Menu", 70, self.game.DISPLAY_W/2, self.game.DISPLAY_H/2 - 50)
    ...
    def display_menu(self):
        ...
        while self.run_display:
            ...
            if self.game.START_KEY or self.game.BACK_KEY:
                ...
                self.run_display = False
            self.game.display.fill(self.game.BLACK)
            self.game.draw_text("Credits", 70, self.game.DISPLAY_W/2, self.game.DISPLAY_H/2 - 50)
            self.game.draw_text("Fait par moi :)", 50, self.game.DISPLAY_W/2, self.game.DISPLAY_H/2)
            self.blit_screen()