...
class Message():
	...
	def __init__(self):
		...
		self.path = r"Z:\\LYCEE\\1e\\1°E\\Timothee Regaud\\"	# Chemin vers le dossier de la messagerie
	...
	def del_user(self, name):
		...
		for i in range(len(self.index)):
			if self.index[i][0] == name:
				os.remove(self.path + "users\\" + str(self.index[i][1]) + ".txt")	# Suppression du fichier de messages de l'utilisateur
